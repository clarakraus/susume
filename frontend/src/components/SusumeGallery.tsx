...
export default function SusumeGallery(props: BlogProps){
    ...
    const susumeList = susumeArray.map(susume =><SusumeComponent key={susume.postId} addToSaveList={props.addToSaveList} susume={susume} privateList={props.privateList}  hasDeleteButton={props.hasDeleteButton} isOnOwnBlog={props.shownOnOwnBlog}/>)
